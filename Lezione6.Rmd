...
Processo di fotolitografia di circuiti stampati
...
Richiamiamo il piano fattoriale per l'impiantoi di filtrazione e *facciamo finta* di aver eseguito solo metà delle prove, compatibilmente con un PF frazionato con relazione definente $I=ABCD$
...
Teniamo solo le righe per cui vale la relazione definente $I=ABCD$, cioè $D=ABC$
